...
assert.deepStrictEqual(
  ...
  [1, 4, 9, 16],
  "Error: n=4 squares do not match",
);

// Test Case 2: n = 5
assert.deepStrictEqual(
  generateFirstSquares(5),
  [1, 4, 9, 16, 25],
  "Error: n=5 squares do not match",
);
...
assert.deepStrictEqual(
  ...
  [],
  "Error: n=0 should return an empty array",
);
...
assert.strictEqual(
  getDayOfWeek("sun"),
  0,
  "Testing Sunday: Result should be 0",
);
assert.strictEqual(
  getDayOfWeek("Mon"),
  1,
  "Testing Monday: Result should be 1",
);
assert.strictEqual(
  getDayOfWeek("xyz"),
  -1,
  "Testing Invalid: Result should be -1",
);
